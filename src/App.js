...
const description = [
	{ descriptor: 'name', value: 'Thrandrill' },
	{ descriptor: 'age', value: '27' }, // desc. comes with Race
	{ descriptor: 'eyes', value: 'Brown' },
	{ descriptor: 'height', value: '6\' 11"' }, // desc. comes with Race
	{ descriptor: 'weight', value: '155lbs' },
	{ descriptor: 'hair', value: 'Brown' },
	{ descriptor: 'alignment', value: 'Neutral-Good' }, // desc. comes with Race
	{ descriptor: 'background', value: 'Smuggler' },
	{ descriptor: 'traits', value: 'Here are some traits' },
	{ descriptor: 'ideals', value: 'Here are some ideals' },
	{ descriptor: 'bonds', value: 'Here are some bonds' },
	{ descriptor: 'flaws', value: 'Here are some flaws' },
	{ descriptor: 'gender', value: 'Male' },
];
const abilities = [
	{ name: 'strength', value: 17 },
	{ name: 'dexterity', value: 15 },
	{ name: 'constitution', value: 10 },
	{ name: 'intelligence', value: 12 },
	{ name: 'wisdom', value: 13 },
	{ name: 'charisma', value: 11 },
];
		...
		return (
			<Router>
				<div className="App">
					...
					<Link to="/class">Choose Class </Link>
					<Link to="/race">Choose Race </Link>
					<Link to="/Equipment">Choose Equipment</Link>

					<Route
						path="/Equipment"
						render={() => {
							return <Equipment equipment={this.state.equipment} />;
						}}
					/>
					<Route
						path="/class"
						render={() => {
							return <CharacterCustomizer name={'Class'} onClick={this.handleClick} list={classes} />;
						}}
					/>
					<Route
						path="/race"
						render={() => {
							return <CharacterCustomizer name={'Race'} onClick={this.handleClick} list={races} />;
						}}
					/>
				</div>
			</Router>
...
// 	`http://www.dnd5eapi.co/api/features/${this.state.class.name.toLowerCase()}/level/${this.state.class.level}`,
// );
